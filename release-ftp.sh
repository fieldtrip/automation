...
then
  ...
  $SCP $BASEDIR/daily/fileio-$TODAY.zip         fieldtrip@server.sccn.ucsd.edu:/path/to/incoming/
  $SCP $BASEDIR/daily/fieldtrip-lite-$TODAY.zip fieldtrip@server.sccn.ucsd.edu:/path/to/incoming/
